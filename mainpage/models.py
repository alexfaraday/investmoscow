...
class Order_Varibles(models.Model): #калькулятор
    ...
    stanki_name_1 = models.ForeignKey(Machines, default=None, null=True, on_delete=models.CASCADE,related_name="stanki_name_1")
    stanki_name_2 = models.ForeignKey(Machines, default=None, null=True, on_delete=models.CASCADE,related_name="stanki_name_2")
    stanki_name_3 = models.ForeignKey(Machines, default=None, null=True, on_delete=models.CASCADE, related_name="stanki_name_3")
    stanki_name_4 = models.ForeignKey(Machines, default=None, null=True, on_delete=models.CASCADE,related_name="stanki_name_4")
