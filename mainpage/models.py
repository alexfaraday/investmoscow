...
class Order_Varibles(models.Model): #калькулятор
    ...
    total_IP_AC6=models.IntegerField(max_length=99,blank=True,null=True)
    total_IP_AC15=models.IntegerField(max_length=99,blank=True,null=True)
    total_IP_AC_OSN=models.IntegerField(max_length=99,blank=True,null=True)
    total_ndfl=models.IntegerField(max_length=99,blank=True,null=True)
    total_pfr=models.IntegerField(max_length=99,blank=True,null=True)
    total_fss=models.IntegerField(max_length=99,blank=True,null=True)
    total_sum=models.IntegerField(max_length=99,blank=True,null=True)
