...
def make_invest_pdf(industry_type,organisation_type,worker_amount,area_type, pfr_min,oms_min, pfr_max, oms_max,rashod_na_account,building_sum_min,ndfl,total_sum_personal):
